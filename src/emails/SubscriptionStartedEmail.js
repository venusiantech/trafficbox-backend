...
function SubscriptionStartedEmail({
  ...
  const formattedDate = periodEnd ? new Date(periodEnd).toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" }) : null;
      ...
      React.createElement(Body, { style: styles.body },
        React.createElement(Container, { style: styles.container },
          ...
          React.createElement(Section, { style: styles.content },
            React.createElement(Text, { style: styles.badge }, "✅ Payment Confirmed"),
            React.createElement(Text, { style: styles.greeting },
              `Your ${planName} plan is now active!`
            ),
            React.createElement(Text, { style: styles.paragraph },
              `Hi ${firstName}, your subscription has been successfully activated. Here are your plan details:`
            ),
            React.createElement(Section, { style: styles.planBox },
              React.createElement(Text, { style: styles.planTitle }, planName.toUpperCase() + " PLAN"),
              ...
              formattedAmount && React.createElement(Text, { style: styles.planDetail }, `💳 ${formattedAmount} charged`),
            ...
            React.createElement(Text, { style: styles.footer },
              "Need help? Contact us at connect@trafficboxes.com"
            ),
...
const styles = {
  ...
  badge: { display: "inline-block", backgroundColor: "#dcfce7", color: "#166534", fontSize: "13px", fontWeight: "600", padding: "4px 12px", borderRadius: "20px", margin: "0 0 16px" },
  ...
  planBox: { backgroundColor: "#f8faff", border: "1px solid #e0e7ff", borderRadius: "8px", padding: "20px" },
  planTitle: { fontSize: "12px", fontWeight: "700", color: "#4f46e5", letterSpacing: "1px", margin: "0 0 12px" },
